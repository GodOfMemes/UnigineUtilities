...
namespace Flex.Data
{
    ...
    /// Nodes have a constant - <see cref="Octree{T}.Node.NumObjectsAllowed"/> - which sets the amount of items allowed in a node before it splits.
    /// 
    ...
    public partial class Octree<T>
    {
        ...
        public BoundingBox MaxBounds => rootNode.Bounds;
        ...
        public BoundingBox[] GetChildBounds()
        {
            ...
            rootNode.GetChildBounds(bounds);
        ...
        public Octree(float initialWorldSize, vec3 initialWorldPos, float minNodeSize, float loosenessVal)
        {
            ...
            minSize = minNodeSize;
            looseness = MathLib.Clamp(loosenessVal, 1.0f, 2.0f);
            rootNode = new Node(initialSize, minSize, looseness, initialWorldPos);
        }
        ...
        /// </summary>
        /// <seealso cref="IsColliding(Data.BoundingBox)"/>
        /// <param name="checkBounds">bounds to check.</param>
        ...
        private void Grow(vec3 direction)
        {
            ...
            vec3 newCenter = rootNode.Center + new vec3(xDirection * half, yDirection * half, zDirection * half);

            // Create a new, bigger octree root node
            rootNode = new Node(newLength, minSize, looseness, newCenter);
